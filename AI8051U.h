...
#define	GPIO_Pin_All	0xFF	//IO ALL

#define	GPIO_PullUp		0	//dule direction with pull up
#define	GPIO_HighZ		1	//float input
#define	GPIO_OUT_OD		2	//OD out
#define	GPIO_OUT_PP		3	//PP out
...
#define	PolityLow			0	//low priority interrupt
